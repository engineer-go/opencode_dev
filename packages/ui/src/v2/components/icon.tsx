...
const icons = {
  ...
  mic: {
    viewBox: "0 0 16 16",
    body: `<path d="M8 2C6.89543 2 6 2.89543 6 4V8C6 9.10457 6.89543 10 8 10C9.10457 10 10 9.10457 10 8V4C10 2.89543 9.10457 2 8 2Z" stroke="currentColor"/><path d="M3.5 7.5V8C3.5 10.4853 5.51472 12.5 8 12.5C10.4853 12.5 12.5 10.4853 12.5 8V7.5M8 12.5V14M6 14H10" stroke="currentColor" stroke-linecap="square"/>`,
  },
  stop: {
    viewBox: "0 0 16 16",
