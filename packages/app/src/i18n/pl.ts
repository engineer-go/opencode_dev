export const dict = {
  ...
  "prompt.action.dictate": "Start dictation",
  "prompt.action.stopDictate": "Stop dictation",
  "prompt.dictation.listening": "Listening... (click stop or press Esc to cancel)",
  "prompt.dictation.transcribing": "Transcribing audio...",
  "prompt.dictation.error.title": "Dictation error",
  "settings.general.section.dictation": "Voice dictation",
  "settings.general.dictation.provider.title": "Transcription provider",
  "settings.general.dictation.provider.description": "Choose the speech-to-text service used to transcribe voice input",
  "settings.general.dictation.groqApiKey.title": "Groq API key",
  "settings.general.dictation.groqApiKey.description": "API key for Groq Cloud Whisper transcription",
  "settings.general.dictation.groqModel.title": "Groq model",
  "settings.general.dictation.groqModel.description": "Groq model ID (default whisper-large-v3-turbo)",
  "settings.general.dictation.openaiApiKey.title": "OpenAI API key",
  "settings.general.dictation.openaiApiKey.description": "API key for OpenAI Whisper transcription",
  "settings.general.dictation.openaiModel.title": "OpenAI model",
  "settings.general.dictation.openaiModel.description": "OpenAI model ID (default whisper-1)",
  "settings.general.dictation.model.title": "Model name",
  "settings.general.dictation.model.description": "Whisper model ID",
  "settings.general.dictation.language.title": "Language hint",
  "settings.general.dictation.language.description": "Optional ISO-639-1 language code (e.g. en, es, ru) or auto",
}
